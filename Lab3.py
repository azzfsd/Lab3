...
def main():
    ...
    print("Sorted an too-long list: ")
    long_arr = arr = [64, 34, 25, 12, 22, 11, 90, 5, 7, 23]
    result = bubble_sort(long_arr, SORT_DESCENDING)
    print(result)


    # Testing of non-integer array
    print("Sorted an non-integer list: ")
    non_int_arr = arr = [64, 34, 25, 12.5, 22, 11, 90]
